...
const adminEmail = 'nikita_rogulin@list.ru'
...
var firebaseConfig = {
  apiKey: "AIzaSyAeCtzJKQ3wcfdJo2H08llymLSJmvHSxfU",
  authDomain: "vvsu-918d2.firebaseapp.com",
  databaseURL: "https://vvsu-918d2-default-rtdb.firebaseio.com",
  projectId: "vvsu-918d2",
  storageBucket: "vvsu-918d2.appspot.com",
  messagingSenderId: "1008028758662",
  appId: "1:1008028758662:web:603def98768b9e610c1707"
};
...
const printPosts = (userID, isPrev) => {
  ...
  database.ref('post').orderByChild('id').once('value', snapshot => {
    ...
    if(userID) {
      ...
      // })
      //  postHolder.innerHTML = postsHTML;
      postHolder.innerHTML = '`<div class="button"> ВОЙДИТЕ В АККАУНТ ДЛЯ ПРОСМОТРА ПОСТОВ </div>`'
      postsHTML = '';
      addPostForm.classList.remove('visible');
      editPostForm.classList.remove('visible');
      postHolder.classList.add('visible');
